...
class Pet {
    ...
    educate() {
        this.education++, this.boredness++, this.hunger++, this.tiredness++;
    ...
    status() {
        console.log(
            `${this.name}'s tiredness is ${this.tiredness} , hunger is ${this.hunger} lonelines is ${this.boredness}`
        );
        if (this.tiredness >= 5 && this.hunger >= 5 && this.boredness >= 5) {
            ...
            displayedText.textContent = `${this.name} is tired & hungry!!`;
        } else if (
            this.tiredness <= 3 &&
            this.hunger > 3 &&
            this.boredness > 3
        ) {
            displayedText.textContent = `${this.name} is bored & hungry!!`;
        } else if (
            this.tiredness > 3 &&
            this.hunger <= 3 &&
            this.boredness > 3
        ) {
            displayedText.textContent = `${this.name} is tired & bored!!`;
        } else if (
            this.tiredness > 3 &&
            this.hunger <= 3 &&
            this.boredness <= 3
